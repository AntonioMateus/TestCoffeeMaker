...
public class Recipe {
    ...
    public void setAmtChocolate(int amtChocolate) throws InvalidValueException {
		if (amtChocolate >= 0 && amtChocolate<=100) {
...
//Erro1:if (amtSugar > 0 && amtSugar<100) {
//Erro2:if (amtSugar >= 0 && amtSugar<100) {
